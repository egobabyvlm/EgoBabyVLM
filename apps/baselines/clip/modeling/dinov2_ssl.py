...
def load_dinov2_config(config_path: str | Path) -> DictConfig:
    ...
    """
    from apps.baselines.dinov2.third_party.dinov2.configs import dinov2_default_config
...
class DINOv2SSL:
    ...
    def __init__(
        ...
        *,
        ...
        from apps.baselines.dinov2.third_party.dinov2 import distributed as dinov2_distributed
        from apps.baselines.dinov2.third_party.dinov2.data import (
            DataAugmentationDINO,
            MaskingGenerator,
            collate_data_and_cast,
        )
        from apps.baselines.dinov2.third_party.dinov2.train.ssl_meta_arch import SSLMetaArch
        from apps.baselines.dinov2.third_party.dinov2.utils.utils import CosineScheduler
        ...
        dinov2_distributed._LOCAL_RANK = int(os.environ.get("LOCAL_RANK", "0"))
        dinov2_distributed._LOCAL_WORLD_SIZE = int(os.environ.get("LOCAL_WORLD_SIZE", "1"))
